...
if(isset($_SESSION['z']) && $_SESSION['continue'] == 1){
    $z = $_SESSION['z'];
    $x = $_SESSION['x'];
    $c = $_SESSION['c'];
...
if($count > 9){
    ...
    echo '<script>location.href="http://junior.catsecurity.net/~unknown/숫자야구.php"</script>';			
}
if($st == 3){
	echo 
...
<html>
	...
	<body>
			...
			<form method="POST" action="숫자save.php">
